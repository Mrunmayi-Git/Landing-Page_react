...
import { fadeIn } from "../ultils/motion.js";
        ...
        <div className='hidden md:flex items-center gap-10'>
            {
                navLinks.map((link, index ) => (
                    ...
                    className={`text-sm font-medium relative after:absolute
                      ...
                      hover:after:w-full after:bg-blue-600
                       after:transition-all
                        ${activeLink === link.href ? "text-blue-600 after:w-full" 
            ...
            <div className='container mx-auto px-4 space-y-3'>
                ...
                onClick={()=> {setActiveLink(link.href);
                 ...
                 className={`block text-sm font-medium py-2 
                    ${activeLink == link.href ? "text-blue-600" : "text-gray-600 hover:text-gray-900" }`} href={link.href}>{link.label}</a>
                )}
